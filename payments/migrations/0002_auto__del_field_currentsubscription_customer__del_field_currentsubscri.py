...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CurrentSubscription.order'
        db.add_column(u'payments_currentsubscription', 'order',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='subscription', unique=True, null=True, to=orm['orders.Order']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'payments_currentsubscription', 'customer',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='current_subscription', unique=True, null=True, to=orm['payments.Customer']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'CurrentSubscription.quantity'
        raise RuntimeError("Cannot reverse this migration. 'CurrentSubscription.quantity' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'CurrentSubscription.quantity'
        db.add_column(u'payments_currentsubscription', 'quantity',
                      self.gf('django.db.models.fields.IntegerField')(),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'CurrentSubscription.plan'
        raise RuntimeError("Cannot reverse this migration. 'CurrentSubscription.plan' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'CurrentSubscription.plan'
        db.add_column(u'payments_currentsubscription', 'plan',
                      self.gf('django.db.models.fields.CharField')(max_length=100),
                      keep_default=False)

        # Deleting field 'CurrentSubscription.order'
        db.delete_column(u'payments_currentsubscription', 'order_id')
